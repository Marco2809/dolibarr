...
$sql.= " s.datec, s.canvas, e.codice_univoco_ufficio_facturebusinessita as ipa";
...
if ($result)
{
	...
	while ($i < min($num,$conf->liste_limit))
	{
        ...
        print ($obj->ipa)?'<td>'.$obj->code_client.' (IPA: '.$obj->ipa.')</td>':'<td>'.$obj->code_client.'</td>'; //ServiceTech
