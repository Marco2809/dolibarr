...
<a id="card" class="tabactive tab inline-block" href="' . $root . '/product/storico_intervento.php?mainmenu=products&leftmenu=product&type=5" data-role="button">Storico intervento</a>
        ...
        print '<div class="inline-block tabsElem">
<a id="price" class="tab inline-block" href="' . $root . '/product/aggiungi_anagrafica.php?mainmenu=products&leftmenu=product&type=6&id=4" data-role="button">Aggiungi anagrafica</a>
</div>';
        ...
        print '<tr class="liste_titre"><td width="30%" colspan="8">' . "Seleziona ordine" . '</td>';
        ...
        $sql = "SELECT * FROM " . MAIN_DB_PREFIX . "form_intervento_zoccali WHERE flag LIKE '%1%'" . $and_condition;
        $result = $db->query($sql);
        if ($result)
        {
            ...
            for ($i = 0; $i < $n; $i++)
            {
                ...
                $down = DOL_URL_ROOT . '/product/ordini/' . $convalida_record['codice_mov'] . ".pdf";
