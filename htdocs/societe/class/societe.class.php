...
class Societe extends CommonObject
{
    ...
    function getNomUrl($withpicto=0,$option='',$maxlen=0)
    {
        ...
        {
           $lien = '<a href="'.DOL_URL_ROOT.'/comm/fiche.php?mainmenu=commercial&socid='.$this->id;
        }
        ...
        {
            $lien = '<a href="'.DOL_URL_ROOT.'/fourn/fiche.php?mainmenu=commercial&socid='.$this->id;
        }
        else if ($option == 'category')
        {
        	$lien = '<a href="'.DOL_URL_ROOT.'/categories/categorie.php?mainmenu=commercial&id='.$this->id.'&type=2';
        }
        else if ($option == 'category_supplier')
        {
        	$lien = '<a href="'.DOL_URL_ROOT.'/categories/categorie.php?mainmenu=commercial&id='.$this->id.'&type=1';
        }

        // By default
        if (empty($lien))
        {
            $lien = '<a href="'.DOL_URL_ROOT.'/societe/soc.php?mainmenu=accountancy&socid='.$this->id;
        }
