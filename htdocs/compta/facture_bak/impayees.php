...
if ($resql)
{
	...
	if ($num > 0)
	{
		...
		while ($i < $num)
		{
			...
			print '<td><a href="'.DOL_URL_ROOT.'/comm/fiche.php?mainmenu=accountancy&socid='.$objp->socid.'">'.img_object($langs->trans("ShowCompany"),"company").' '.dol_trunc($objp->nom,28).'</a></td>';
