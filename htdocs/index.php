...
{
    header("Location: " . DOL_URL_ROOT . "/product/elenco_famiglia.php?mainmenu=products&leftmenu=");
}
if ($user->login == "st_solari")
{
    header("Location: " . DOL_URL_ROOT . "/product/elenco_asset.php?mainmenu=products&leftmenu=");
}
...
if ($user->login == "magazzino")
{
    header("Location: " . DOL_URL_ROOT . "/product/index.php?mainmenu=products");
}
...
if ($user->tipologia == "T" || $user->tipologia == "M" || $user->tipologia == "A")
{
        ...
        header("Location: " . DOL_URL_ROOT . "/product/stock/fiche.php?id=$cod_mag&mainmenu=products&log_ticket=1");
}
...
if ($user->datepreviouslogin)
    print dol_print_date($user->datepreviouslogin, "dayhour", 'tzuser');
else
