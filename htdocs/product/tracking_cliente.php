...
<a id="card" class="tab inline-block" href="' . $path . '/product/scheda_cliente.php?mainmenu=products&TERMID=' . $cod_asset . '"' . 'data-role="button">Scheda</a>
</div>';

        print '<div class="inline-block tabsElem">
<a id="card" class="tabactive tab inline-block" href="' . $path . '/product/tracking_cliente.php?mainmenu=products&cliente=' . $cod_asset . '"' . 'data-role="button">Tracking</a>
</div>';
