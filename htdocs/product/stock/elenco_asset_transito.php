...
$id_magazzino = GETPOST("id_magazzino");; // GETPOST("id_magazzino");
...
$texte = "Elenco asset in transito";
...
$order_by;
$select;
$lista_magazzini = $mag_obj->getMagazziniSelect("*");
$statutarray = array();
...
$array_condizione [] = "a.stato_fisico = 3"; // stato fisico 
...
print_barre_liste($texte, $page, "fiche.php", $param, $sortfield, $sortorder, '', $num, $nbtotalofrecords, "asset.png");
...
} else
{
    ...
    print_liste_field_titre("Codice asset", $_SERVER["PHP_SELF"], "a.cod_asset", $param, "", "", $sortfield, $sortorder);
    ...
    print_liste_field_titre("Data Creazione", $_SERVER["PHP_SELF"], "a.data_creazione", $param, "", 'align="center"', $sortfield, $sortorder);

    print_liste_field_titre("Data ultima modifica", $_SERVER["PHP_SELF"], "a.data_modifica", $param, "", 'align="center"', $sortfield, $sortorder);
    ...
    print '<td align="center">';
    print $form->selectarray('stato_fisico', array('3' => "Transito"), 3, 3);
    print '</td >';
    ...
    while ($i < min($num, $limit))
    {
        ...
        if (!empty($obj_asset))
        {
            ...
            print '<td>' . $obj_asset->data_creazione . '</td>';

            print '<td>' . $obj_asset->data_modifica . '</td>';
            print "</tr>\n";
        }
        $i++;
    }
    ...
    $param .=!empty($stato_fisico) ? "&amp;stato_fisico=$stato_fisico" : "";
    $param .=!empty($stato_tecnico) ? "&amp;stato_tecnico=$stato_tecnico" : "";
    print_barre_liste('', $page, "fiche.php", $param, $sortfield, $sortorder, '', $num, $nbtotalofrecords);
