...
<html>
  <head>
    <meta charset="utf-8">
    <title>Aggiungi asset da movimentare</title>
  </head>
  <style>
    body {
        background: #fafafa ;
  ...
  <body>
    <form action="">
      <table style="margin-bottom:-20px;">
        <thead>
          <tr>
            <th><span style="font-size:20px; color:#8ec25a;">Allega a Movimento - Asset</span></th>
          </tr>
        </thead>
      </table>
      <table>
        ...
        <td>
         ...
         <!--   <option value = "ric_etichetta">Etichetta</option> -->
            <option value="ric_codefamiglia">Famiglia</option>
      ...
      if (!empty($add_asset)) // se sono stati già inseriti asset
      {
          ...
          {
              $path = DOL_URL_ROOT . '/product/popup_asset.php?mainmenu=products';
