...
$fontlist='Century Gothic,Verdana,Helvetica,Arial,sans-serif';
//$img_head=dol_buildpath($path.'/theme/'.$theme.'/img/parete.png',1);
...
$colorbacklinepair1='10,10,10';    // line pair
...
{
	$conf->global->THEME_ELDY_TOPMENU_BACK1='120,180,61';    // topmenu
    $conf->global->THEME_ELDY_TOPMENU_BACK2='23,23,23';
	$conf->global->THEME_ELDY_VERMENU_BACK1='23,23,23';    // vmenu
    $conf->global->THEME_ELDY_VERMENU_BACK1b='23,23,23';   // vmenu (not menu)
    $conf->global->THEME_ELDY_VERMENU_BACK2='23,23,23';
    $conf->global->THEME_ELDY_BACKTITLE1='23,23,23';       // title of arrays
    $conf->global->THEME_ELDY_BACKTITLE2='23,23,23';
    $conf->global->THEME_ELDY_BACKTABCARD2='23,23,23';     // card
    $conf->global->THEME_ELDY_BACKTABCARD1='23,23,23';
    $conf->global->THEME_ELDY_BACKTABACTIVE='23,23,23';
    //$conf->global->THEME_ELDY_BACKBODY='#ffffff url('.$img_head.') 0 0 no-repeat;';
    $conf->global->THEME_ELDY_BACKBODY='23,23,23';
    $conf->global->THEME_ELDY_LINEIMPAIR1='242,242,242';
    $conf->global->THEME_ELDY_LINEIMPAIR2='248,248,248';
    $conf->global->THEME_ELDY_LINEIMPAIRHOVER='23,23,23';
    $conf->global->THEME_ELDY_LINEPAIR1='255,255,255';
    $conf->global->THEME_ELDY_LINEPAIR2='255,255,255';
    $conf->global->THEME_ELDY_LINEPAIRHOVER='23,23,23';
    $conf->global->THEME_ELDY_TEXT='23,23,23';
	if ($dol_use_jmobile)
	{
    	$conf->global->THEME_ELDY_BACKTABCARD1='23,23,23';    // topmenu
		$conf->global->THEME_ELDY_BACKTABCARD2='23,23,23';
		$conf->global->THEME_ELDY_BACKTABACTIVE='23,23,23';
	}
}
...
$tmpval=(! empty($tmppart[1]) ? $tmppart[1] : '')+(! empty($tmppart[2]) ? $tmppart[2] : '')+(! empty($tmppart[3]) ? $tmppart[3] : '');
if ($tmpval <= 360) { $colortexttitle='669933'; $colorshadowtitle=''; }
...
<?php } else { ?>
    ...
    <?php if ($usecss3) { ?>
	background-image: linear-gradient(top, rgba(102,102,102,.3) 0%, rgba(128,128,128,.3) 100%);
	background-image: -o-linear-gradient(top, rgba(102,102,102,.3) 0%, rgba(128,128,128,.3) 100%);
	background-image: -moz-linear-gradient(top, rgba(102,102,102,.3) 0%, rgba(128,128,128,.3) 100%);
...
div.mainmenu.logo{
	background-image: url(<?php echo dol_buildpath($path.'/theme/'.$theme.'/img/menus/logo.png',1) ?>);
...
.bodylogin
{
	background: #ccc; /*url(<?php echo $img_head; ?>) 0 0 no-repeat;*/
	color: #669933;
...
.container {
  background-color:#1E1E1E;
	background-image: url(../../theme/eldy/img/parete.png) , radial-gradient(300px 500px at center, #669933 0%, rgba(0,0,0,0) 50%, rgba(0,0,0,0));
