...
if ($action == 'add' && $canadduser)
{
    ...
    if (! $message)
    {
        ...
        $object->tipologia = GETPOST("tipologia_mag");
...
if (($action == 'create') || ($action == 'adduserldap'))
{
    ...
    //tipologia magazzino (modificato da amin)
    print '<tr><td>' . "Seleziona tipologia" . '</td><td colspan="3">';
    print '<select name="tipologia_mag">';
    print '<option value=' . "N" . '>' . "NULL" . '</option>';
    print '<option value=' . "T" . '>' . "Tecnico" . '</option>';
    print '<option value=' . "M" . '>' . "Magazzino" . '</option>';
