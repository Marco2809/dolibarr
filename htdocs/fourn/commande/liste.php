...
if ($resql)
{
	...
	while ($i < min($num,$conf->liste_limit))
	{
		...
		// Ref
		print '<td><a href="'.DOL_URL_ROOT.'/fourn/commande/fiche.php?mainmenu=commercial&id='.$obj->rowid.'">'.img_object($langs->trans("ShowOrder"),"order").' '.$obj->ref.'</a>';
		...
		// Company
		print '<td><a href="'.DOL_URL_ROOT.'/fourn/fiche.php?mainmenu=commercial&socid='.$obj->socid.'">'.img_object($langs->trans("ShowCompany"),"company").' ';
		print $obj->nom.'</a></td>'."\n";
