...
class pdf_canelle extends ModelePDFSuppliersInvoices
{
	...
	function write_file($object, $outputlangs='', $srctemplatepath='', $hidedetails=0, $hidedesc=0, $hideref=0)
	{
		...
		if ($conf->fournisseur->dir_output.'/facture')
		{
			...
			if (file_exists($dir))
			{
				...
				if (! empty($object->array_options['options_fornitore_cig']) or !empty($object->array_options['options_fornitore_nordine']) or !empty($object->array_options['options_fornitore_oggetto']))
                {
					$cig="\r\nNum. Ordine: ".$object->array_options['options_fornitore_nordine']."\r\nCIG: ".$object->array_options['options_fornitore_cig']."\r\nOggetto: ".$object->array_options['options_fornitore_oggetto'];
					$tab_top = 88;
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		if ($object->ref_supplier)
		{
    		...
    		$pdf->MultiCell(100, 4,"N° Fattura fornitore: " . $object->ref_supplier, '', 'R');
		}
