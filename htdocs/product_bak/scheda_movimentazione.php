...
<a id="price" class="tabactive tab inline-block" href="' . $root . '/product/storico.php?leftmenu=product&type=6&id=4" data-role="button">Storico</a>
        ...
        $select_due .= '<option value=' . $key . $selected . '>' . $magazzino_destinatario[0]['label'] . '</option>';
        $select_due .= '</select>';
        ...
        print '<td><input name="dati[causale_trasp]" size="40" value="' . $movimentazione->causale_trasp . '" disabled="disabled">';
        print '</td></tr>';

        print '<tr><td width="20%">' . "Luogo di destinazione" . '</td>'; // non modificabile
        print '<td><input name="dati[luogo_dest]" size="40" value="' . $movimentazione->luogo_dest . '" disabled="disabled">';
        print '</td></tr>';
        ...
        print '<input name="trasp_mezzo" size="16" value="'.$trasporto_mezzo.'" disabled="disabled">';//$form->selectarray('trasp_mezzo', $trasporto, GETPOST('trasp_mezzo'));
        print '<input name="vettore_nota" size="30" value="'.$movimentazione->annotazioni.'"disabled="disabled">';
        print '</td></tr>';
        ...
        print '<td><input name="dati[annotazioni]" size="16" value="' . $movimentazione->annotazioni . '" disabled="disabled">';
        print '</td></tr>';
        
        print '<tr><td width="20%">' . "Codice asset in transito" . '</td>'; //oni non modificabile
        print '<td><input name="dati[annotazioni]" size="100" value="' . $movimentazione->checkbox_asset . '" disabled="disabled">';
        print '</td></tr>';
