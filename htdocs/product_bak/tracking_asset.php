...
<a id="card" class="tab inline-block" href="' . $path . '/product/scheda_asset.php?mainmenu=products&cod_asset=' . $cod_asset . '"' . 'data-role="button">Scheda</a>
</div>';

        print '<div class="inline-block tabsElem">
<a id="card" class="tabactive tab inline-block" href="' . $path . '/product/tracking_asset.php?mainmenu=products&cod_asset=' . $cod_asset . '"' . 'data-role="button">Tracking</a>
</div>';
...
for ($i = 0; $i < count($tracking); $i++)
{
    ...
    if (strcasecmp($tracking[$i]['azione'], "modifica stato fisico") == 0)
    {
        ...
        if (!empty($tracking[$i]['id_ticket']))
        {
            ...
            print "<td>tck " . $tracking[$i]['riferimento'] . "</td>";
    ...
    if (strcasecmp($tracking[$i]['azione'], "Censito Guasto da Ticket") == 0)
    {
        print "<td></td>";
        print "<td></td>";
        if (!empty($tracking[$i]['id_ticket']))
        {
            $url_ticket = "http://ticket.service-tech.org/scp/tickets.php?id=" . $tracking[$i]['id_ticket'];
         //   print "<td>tck " . $tracking[$i]['riferimento'] . "</td>";
             $link_ticket = '<td><a href=' . $url_ticket . ' >' . $tracking[$i]['riferimento'] . '</a></td>';
              print $link_ticket;
        }
