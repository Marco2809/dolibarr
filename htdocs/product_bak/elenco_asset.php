...
} else
{
    ...
    if ($res_query)
    {
        ...
        } else
        {
            ...
            // Lignes des titres
            print '<tr class="liste_titre">';
            print_liste_field_titre("Codice", $_SERVER["PHP_SELF"], "a.cod_asset", $param, "", "", $sortfield, $sortorder);
            ...
            print '<td align="center">';
            print $form->selectarray('stato_fisico', array('1' => "Giacenza", '2' => "In uso", '3' => "In lab", '4' => "Dismesso"), $stato_fisico, 1);
            print '</td >';
