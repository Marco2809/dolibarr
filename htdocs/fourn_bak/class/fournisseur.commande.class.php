...
class CommandeFournisseur extends CommonOrder
{
    ...
    function fetch($id,$ref='')
    {
        ...
        if ($resql)
        {
            ...
            $sql.= " l.localtax1_tx, l. localtax2_tx, l.total_localtax1, l.total_localtax2,l.date_start, l.date_end,";
            ...
            if ($result)
            {
                ...
                while ($i < $num)
                {
                    ...
                    $line->date_start		   = $this->db->jdate($objp->date_start); //ServiceTech
                    $line->date_end			   = $this->db->jdate($objp->date_end); //ServiceTech
                    $this->lines[$i]      = $line;
...
class CommandeFournisseurLigne
{
    ...
    function fetch($rowid)
    {
        ...
        $sql.= ' cd.total_localtax1, cd.total_localtax2, cd.date_start, cd.date_end,';
        ...
        if ($result)
        {
            ...
            $this->date_start		= $this->db->jdate($obj->date_start); //Service Tech
            $this->date_end			= $this->db->jdate($obj->date_end); //Service Tech
